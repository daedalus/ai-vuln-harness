...
from ai_vuln_harness.stages.parser import _extract_objects, parse_findings
...
class ShieldDeduplicateEdgeTests(unittest.TestCase):
    ...
    def test_single_token_descriptions(self):
        ...
        from ai_vuln_harness.stages.shield import deduplicate_semantic
    ...
    def test_cosine_empty_vectors(self):
        from ai_vuln_harness.stages.shield import cosine_similarity
